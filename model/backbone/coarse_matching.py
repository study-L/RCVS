...
class CoarseMatching(nn.Module):
    ...
    def forward(self, feat_c0, feat_c1, data, mask_c0=None, mask_c1=None):
        ...
        if 'last_feat_c0' in data:
            ...
            sim_matrix_vi = torch.einsum("nlc,nsc->nls", last_feat_c0,feat_c0) / self.temperature
            ...
            mkpts0_c = torch.stack(
                [vi_all_j_ids[0] % data['hw0_c'][1], vi_all_j_ids[0] // data['hw0_c'][1]],
                dim=1) * 8
            mkpts1_c = torch.stack(
                [ir_all_j_ids[0] % data['hw1_c'][1], ir_all_j_ids[0] // data['hw1_c'][1]],
                dim=1) * 8
        ...
        data.update({'last_feat_c0': feat_c0, 'last_feat_c1': feat_c1})
